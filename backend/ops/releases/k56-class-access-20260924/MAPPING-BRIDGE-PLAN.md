...
| B6 — hợp đồng local đã chuẩn bị, chưa chạy live | Lượt đồng bộ tiếp theo → đối soát trạng thái đủ điều kiện và quan sát | Giữ roster/UUID/bài cũ, chỉ đổi `is_eligible` cho học viên rời hoặc quay lại và tắt quyền lớp rời phạm vi; chặn drift chưa xử lý trước B5. Chỉ lên lịch khi đã có giao dịch, khóa chạy trùng, cảnh báo nguồn cũ/giảm số lượng và rollback đã thử. |
